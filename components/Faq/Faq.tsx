import FaqTitle from "site/components/Faq/FaqTitle.tsx";
import Dropdown from "site/components/Faq/Dropdown.tsx";
...
export default function Faq({ props }: { props: Props }) {
  ...
  return (
    <div class="w-full h-full bg-black relative z-[1]">
      <div class="py-10 md:py-[80px] px-4 container pt-[80px] md:pt-[120px]">
